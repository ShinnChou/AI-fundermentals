...
本小节重点介绍 GPU 编程的底层逻辑与 CUDA 并行计算的基础概念。
...
本小节提供完整的 GPU 编程技术路径，涵盖架构理解与实战调优。
...
随着 Tensor Core 等专用加速单元的引入，传统的 SIMT 编程模型在某些场景下面面临挑战。本小节探讨 Tile-Based 编程如何引入数据块视角，简化高性能算子的开发。
...
本章探讨在 AI 时代下新兴的应用层开发范式与工作流，重点关注如何利用各种编程语言、框架和编排工具构建复杂的 LLM 应用及 Agent 系统。

### 5.1 Java AI 开发

本节主要介绍在 Java 生态系统中开发大语言模型应用的技术栈。
...
本节探讨在 AI 辅助下新兴的编程范式与工作流，重点关注如何利用 AI 提升开发效率与代码质量。
...
本节介绍 LangGraph 框架，它是一个用于构建有状态、多智能体应用程序的库，特别适合构建复杂的 Agent 工作流。
...
本节介绍如何使用 Coze、n8n 等无代码或低代码工具进行 AI 应用的编排与落地。
...
本节介绍大语言模型的基础理论，涵盖从文本处理到模型架构的核心概念。理解这些基础概念是深入学习 LLM 技术的前提，为后续的模型训练和应用奠定理论基础。
...
本节涵盖混合专家系统、量化技术、思维链推理等前沿技术，这些技术代表了当前 LLM 领域的最新发展方向。
...
- [**量化技术可视化指南**](06_llm_theory_and_fundamentals/llm_basic_concepts/01_visual_guide_to_quantization.md) - 模型压缩与加速的核心技术
...
大模型的训练是一个复杂且系统的工程，涉及数据处理、分布式训练、指令微调等多个关键环节。本章将详细介绍从指令微调（SFT）到大规模模型预训练的完整技术路径，结合 70B 参数模型的实战案例，深入探讨训练基础设施的搭建、超参数优化及模型后训练（Post-Training）策略。
...
本节汇总了关于 DeepSeek 模型的部署、对比分析和存储系统设计等核心资料。

- [**DeepSeek 3FS 存储系统**](04_cloud_native_ai_platform/storage/deepseek_3fs/01_deepseek_3fs_design_notes.md) - DeepSeek 自研的高性能分布式文件系统设计笔记
...
本节涵盖 RAG 的基础与进阶技术，包括分块策略、Embedding 选型及知识图谱应用。
...
### 13.1 AI System 全栈课程（ZOMI 酱）

本节介绍 ZOMI 酱的 AI 系统全栈课程，涵盖从硬件基础到框架设计的全技术栈内容。

[**AISystem**](https://github.com/Infrasys-AI/AISystem) - AI 系统全栈课程代码与资料库：
