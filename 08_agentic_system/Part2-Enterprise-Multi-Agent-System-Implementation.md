...
完整的BDI架构实现请参考：[`src/agents/base_agent.py`](../10_ai_related_course/multi_agent_system/multi_agent_system/src/agents/base_agent.py)
...
- **配置文件**：[`config.json`](../10_ai_related_course/multi_agent_system/multi_agent_system/config.json) - 系统配置
- **部署文件**：[`docker-compose.yml`](../10_ai_related_course/multi_agent_system/multi_agent_system/docker-compose.yml) - 容器化部署
