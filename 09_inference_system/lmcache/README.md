...
**4. [LMCache 分层存储架构与调度机制详解](./lmcache_storage_overview.md)**
...
**5. [LocalCPUBackend 源码分析](./local_cpu_backend.md)** (L1 内存层)

- **核心内容**: 内存分配器 (Allocator)、锁粒度优化、NUMA 亲和性。
- **目标**: 理解高性能内存管理与并发控制。

**6. [LocalDiskBackend 源码分析](./local_disk_backend.md)** (L3 磁盘层)
